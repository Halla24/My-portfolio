      ...
      <div className="group">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          ...
          <div className="text-white absolute z-10">
           <div
           className="bg-[#4B2499]  text-white font-serif  px-4 py-2 rounded-md transition-all duration-300 transform hover:scale-105 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl"
